...
{
    private Character(string name, string description1, string description2, string description3, float weight, string entryLine, string exitLine, string[] lines)
    {
        this.name = name;
    ...
    public static Character dummy1 = new Character("Tanya Dezora", "Your little sister.... Wait, what is she doing here ?", "", "", 55f * WeightMultiplicator,
    ...
    public static Character dummy2 = new Character("Father Rohn", "A priest at the church, will do his best to guide you to do right path.", "", "", 95f * WeightMultiplicator,
    ...
    public static Character dummy3 = new Character("Rikka Leron", "A really energic high school girl... Maybe a bit too much.", "", "", 85f * WeightMultiplicator,
