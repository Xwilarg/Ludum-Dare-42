...
public class Character
{
    ...
    public static Character tsundere = new Character("Hanashi Tsubaka",
        ...
        "You ended up alone with your childhood tsundere friend, Hanashi Tsubaka. You didn't manage to create a new world but at least you could now die peacefully as she confessed to you.", 10f);
